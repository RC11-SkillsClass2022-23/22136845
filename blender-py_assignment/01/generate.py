...
import re
import os.path
f = open("E:\\OneDrive - University College London\\UCL\\Blender\\data.txt","r")
...
for i in range(1335,1427):
    loc = "E:\\OneDrive - University College London\\UCL\\Blender\\IMG_"
    loc += str(i)
    loc += ".jpg"
